...
{   
    ...
    centralCrys	= new Int_t[GAcquTREEMANAGER_MAX_PARTICLE];
    centralVeto   	= new Int_t[GAcquTREEMANAGER_MAX_PARTICLE];
...
Bool_t  GoATTreeManager::InitTreeParticles(TFile* TreeFile)
{
	...
	treeParticles->Branch("centralCrys", centralCrys,"centralCrys[nParticles]/I");
	treeParticles->Branch("centralVeto", centralVeto,"centralVeto[nParticles]/I");
...
Bool_t    GoATTreeManager::OpenTreeParticles(TFile* TreeFile)
{
	...
	treeParticles->SetBranchAddress("centralCrys", centralCrys);
	treeParticles->SetBranchAddress("centralVeto", centralVeto);
