...
public:
	...
	void	SetCentralCrys(Int_t index, Int_t value)	{centralCrys[index] = value;}
	void	SetCentralVeto(Int_t index, Int_t value)	        {centralVeto[index] = value;}
	...
	Int_t   	GoATTree_GetCentralCrys(const Int_t index) 	const 	{return centralCrys[index];}
	Int_t   	GoATTree_GetCentralVeto(const Int_t index) 	const 	{return centralVeto[index];}
